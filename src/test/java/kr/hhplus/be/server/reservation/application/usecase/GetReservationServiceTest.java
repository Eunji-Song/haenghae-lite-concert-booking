...
class GetReservationServiceTest {
    ...
    void getMy_success() {
        when(userRepo.findIdByUserUuid("u")).thenReturn(java.util.Optional.of(1L));
        var r1 = new Reservation(1L, 1L, 10L, 100L, 1000L, ReservationStatus.PENDING, 1000L, null, null, null, null, true, null, LocalDateTime.now(), LocalDateTime.now());
        var r2 = new Reservation(2L, 1L, 11L, 101L, 1001L, ReservationStatus.CANCELED, 2000L, null, null, LocalDateTime.now(), null, true, null, LocalDateTime.now(), LocalDateTime.now());
